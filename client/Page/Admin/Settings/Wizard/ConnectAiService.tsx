  ...
  return (
    <div className="max-w-[380px] mx-auto text-base mt-12">
      ...
      <div className="text-lg mt-4">
        To begin using AgentWP, connect it to the Al services. If this is your
        first time connecting this site, a quick indexing process will take
        place.
      </div>
      ...
      <div className="mt-4 ">
        Your data is private. It will never be used for AI training, and is
