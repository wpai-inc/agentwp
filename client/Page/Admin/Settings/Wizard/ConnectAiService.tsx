    ...
    return (
        <div className="max-w-[380px] mx-auto text-base mt-12">
                ...
                <ul className="mt-2">
                    <li>
                        <div className="flex gap-4">
                            <svg width="37" height="37" className="pt-2" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                    ...
                    <li>
                        <div className="flex gap-4">
                            <svg width="34" height="34" className="pt-2" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                    ...
                    <li>
                        <div className="flex gap-4  items-center">
                            <svg width="24" height="34" viewBox="0 0 24 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5" d="M13.6 3.4H10.2L8.5 0H15.3L13.6 3.4ZM15.3 10.2V6.8H17V5.1H6.8V6.8H8.5V10.2C3.808 10.2 0 14.008 0 18.7V34H23.8V18.7C23.8 14.008 19.992 10.2 15.3 10.2ZM18.7 25.5H13.6V30.6H10.2V25.5H5.1V22.1H10.2V17H13.6V22.1H18.7V25.5Z" fill="black" />
                            </svg>
            ...
            <div className="mt-4 text-sm">
                By connecting, you agree to the <a href="#" className="underline">Terms</a> and <a href="#" className="underline">Privacy Policy</a>.
            </div>
        </div>
    );
}
