...
export default function UsersManagement() {
    ...
    function setManageAgentwpUsers(user: any) {
        ...
        adminRequest.post("?action=agentwp_update_user", { user: user.id, manage_agentwp_users: !user.manage_agentwp_users});
    ...
    function setAgentwpAccess(user: any) {
        ...
        adminRequest.post("?action=agentwp_update_user", { user: user.id, agentwp_access: !user.agentwp_access});
                ...
                {users.map((user: any) => {
                    return (
                        <tr key={user.id}>
                            ...
                            <td>
                                <input type="checkbox" checked={user.agentwp_access} onChange={() => setAgentwpAccess(user)} />
                            </td>
                            <td>
                                <input type="checkbox" checked={user.manage_agentwp_users} onChange={() => setManageAgentwpUsers(user)} />
                            </td>
                        </tr>
                    );
                })}
