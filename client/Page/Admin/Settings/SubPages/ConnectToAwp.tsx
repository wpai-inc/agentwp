...
export default function connectToAwp() {
  ...
  return (
    <div>
      ...
      {page.site_id && <div>Your site is connected to agentwp. Your site ID is {page.site_id}</div>}

      <br />
      {page.site_id && !loggedIn && (
        <div className="flex gap-4">
          <Button onClick={authorize} variant="brand" disabled={authorizing} isBusy={authorizing}>
            Login to AWP
          </Button>
          <Button
            onClick={disconnect}
